...
class _WhereAmIScreenState extends State<WhereAmIScreen> {
  ...
  Future<void> _getPrediction() async {
    ...
    try {
      final uri = Uri.parse('http://192.168.1.4:8000/predict_where_im');
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _predictedPlace = data['place'];
        });
      } else {
        setState(() {
          _predictedPlace = 'Error: Unable to get prediction.';
        });
      }
    } catch (e) {
      setState(() {
        _predictedPlace = 'Error: $e';
      });
    } finally {
      setState(() {
        _isLoading = false;
                        ...
                        child: ClipRRect(
                          ...
                          child: _image != null
                            ...
                            children: [
                              ...
                              SizedBox(height: 12),
                              Text(
                                'Upload your location image here',
                                style: TextStyle(
