...
class _TripPlannerScreenState extends State<TripPlannerScreen> {
  ...
  Future<void> _submitPlanRequest() async {
    ...
    try {
      print("Sending trip plan request...");
      final response = await http.post(
        Uri.parse('http://192.168.1.4:8000/plan_trip'),
      ...
      if (response.statusCode == 200) {
        try {
          ...
          } else if (responseData.containsKey('itinerary')) {
            setState(() {
              _tripPlan = responseData['itinerary'];
            });
            ScaffoldMessenger.of(context).showSnackBar(
      ...
      if (errorMessage.contains('SocketException') || 
        ...
        errorMessage = 'Server connection error: Please make sure the backend server is running on your computer';
      }
